...
directory does a lot of that for you. You would run it like so:
    ...
    go get github.com/xenking/oapi-codegen/cmd/oapi-codegen
...
import (
	...
	"github.com/xenking/oapi-codegen/examples/petstore-expanded/gin/api"
	middleware "github.com/xenking/oapi-codegen/pkg/gin-middleware"
)
...
[`/internal/test/externalref/`](https://github.com/xenking/oapi-codegen/blob/master/internal/test/externalref/externalref.cfg.yaml)
...
generate:
  ...
  - skip-prune
import-mapping:
  ./packageA/spec.yaml: github.com/xenking/oapi-codegen/internal/test/externalref/packageA
  ./packageB/spec.yaml: github.com/xenking/oapi-codegen/internal/test/externalref/packageB
```

Have a look at [`cmd/oapi-codegen/oapi-codegen.go`](https://github.com/xenking/oapi-codegen/blob/master/cmd/oapi-codegen/oapi-codegen.go#L48) 
